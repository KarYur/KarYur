...
def calculate_and_draw():
    ...
    result_label.config(text=f"Итоговый стоимость: {sebestoimost:.2f} РУБ.")
    ...
    # door_width = shirina // door
    # for i in range(door):
    #     draw.rectangle([(i * door_width, 0), ((i + 1) * door_width, visota)], outline="black", width=3)
